...
export type NotRunningResult = NotRunningTag & {
  reason: "not-started" | "spawn-failed";
  coqtop?: string;
};
...
export namespace InterruptCoqRequest {
  export const type = new RequestType<CoqTopParams, void, void, void>(
    "coqtop/interrupt"
  );
}
...
export namespace StepForwardRequest {
  export const type = new RequestType<CoqTopParams, CommandResult, void, void>(
    "coqtop/stepForward"
  );
}
...
export namespace InterpretToPointRequest {
  export const type = new RequestType<
    CoqTopInterpretToPointParams,
    CommandResult,
    void,
    void
  >("coqtop/interpretToPoint");
}
export namespace InterpretToEndRequest {
  export const type = new RequestType<
    InterpretToEndParams,
    CommandResult,
    void,
    void
  >("coqtop/interpretToEnd");
}
...
export namespace FinishComputationsRequest {
  export const type = new RequestType<CoqTopParams, void, void, void>(
    "coqtop/finishComputations"
  );
}
export namespace QueryRequest {
  export const type = new RequestType<CoqTopQueryParams, void, void, void>(
    "coqtop/query"
  );
}
...
export namespace SetDisplayOptionsRequest {
  export const type = new RequestType<
    CoqTopSetDisplayOptionsParams,
    void,
    void,
    void
  >("coqtop/setDisplayOptions");
}
...
export namespace LtacProfResultsRequest {
  export const type = new RequestType<
    CoqTopLtacProfResultsParams,
    void,
    void,
    void
  >("coqtop/ltacProfResults");
}
...
export namespace UpdateHighlightsNotification {
  export const type = new NotificationType<NotifyHighlightParams, void>(
    "coqtop/updateHighlights"
  );
}
...
export namespace CoqMessageNotification {
  export const type = new NotificationType<NotifyMessageParams, void>(
    "coqtop/message"
  );
}

export namespace CoqResetNotification {
  export const type = new NotificationType<NotificationParams, void>(
    "coqtop/wasReset"
  );
}
...
export namespace CoqtopStartNotification {
  export const type = new NotificationType<NotificationParams, void>(
    "coqtop/coqtopStarted"
  );
}

export enum CoqtopStopReason {
  UserRequest,
  Anomaly,
  InternalError
}
...
export namespace CoqtopStopNotification {
  export const type = new NotificationType<NotifyCoqtopStopParams, void>(
    "coqtop/coqtopStopped"
  );
}
...
export namespace CoqStmFocusNotification {
  export const type = new NotificationType<DocumentPositionParams, void>(
    "coqtop/stmFocus"
  );
}
...
export namespace CoqLtacProfResultsNotification {
  export const type = new NotificationType<NotifyLtacProfResultsParams, void>(
    "coqtop/ltacProfResults"
  );
}
